...
#ifndef DUK_F_MIPS32
#error "DUK_F_MIPS32 not defined" 
#endif
...
#else
#define DUK_F_GCC_VERSION 20702
...
#define DUK_F_HAVE_64BIT
typedef unsigned long long duk_uint64_t; // this is the correct one for n64 (see ultratypes.h)
typedef signed long long duk_int64_t;
#endif
#endif
...
#define DUK_INT_MIN           (int)INT_MIN
#define DUK_INT_MAX           (int)INT_MAX
...
// override byte order __BYTE_ORDER__: 4321
...
#if DUK_USE_BYTEORDER != 3
#pragma message "DUK_USE_BYTEORDER: " XSTR(DUK_USE_BYTEORDER)
#pragma message "__BYTE_ORDER__: " XSTR(__BYTE_ORDER__)
#pragma message "__ORDER_BIG_ENDIAN__: " XSTR(__ORDER_BIG_ENDIAN__)
#pragma message "__FLOAT_WORD_ORDER__: " XSTR(__FLOAT_WORD_ORDER__) 
...
#define DUK_USE_DEBUG_BUFSIZE 4096
